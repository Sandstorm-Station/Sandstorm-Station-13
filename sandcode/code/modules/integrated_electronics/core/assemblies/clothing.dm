// Sandstorm, clothing circuitry and yes i hate having to do this thing.
...
/obj/item/clothing/attackby(obj/item/I, mob/user)
	if(IC)
		...
		if(istype(I, /obj/item/integrated_circuit) || istype(I, /obj/item/stock_parts/cell) || istype(I, /obj/item/integrated_electronics) || istype(I, /obj/item/integrated_electronics/debugger) || istype(I, /obj/item/multitool) || istype(I, /obj/item/integrated_electronics/detailer))
			IC.attackby(I, user)
		else if(istype(I, /obj/item/screwdriver))
			IC.screwdriver_act(user, IC)
	else
		..()
...
/obj/item/clothing/proc/setup_integrated_circuit(new_type)
	...
	actions_types = list(/datum/action/item_action/circuit_activate)
...
/obj/item/clothing/under/circuitry
	...
	icon = 'sandcode/icons/obj/clothing/circuitry/uniforms.dmi'
	mob_overlay_icon = 'sandcode/icons/mob/clothing/circuitry/under.dmi'
	anthro_mob_worn_overlay = 'sandcode/icons/mob/clothing/circuitry/under.dmi'
...
/obj/item/clothing/gloves/circuitry
	...
	icon = 'sandcode/icons/obj/clothing/circuitry/gloves.dmi'
	mob_overlay_icon = 'sandcode/icons/mob/clothing/circuitry/gloves.dmi'
	anthro_mob_worn_overlay = 'sandcode/icons/mob/clothing/circuitry/gloves.dmi'
	icon_state = "circuitry"
	item_state = "circuitry"
...
/obj/item/clothing/gloves/ewatch
	...
	icon = 'sandcode/icons/obj/clothing/circuitry/ewatch.dmi'
	mob_overlay_icon = 'sandcode/icons/mob/clothing/circuitry/ewatch.dmi'
	anthro_mob_worn_overlay = 'sandcode/icons/mob/clothing/circuitry/ewatch.dmi'
	icon_state = "circuitry"
	item_state = "circuitry"

/obj/item/clothing/gloves/watch/Initialize()
	setup_integrated_circuit(/obj/item/electronic_assembly/clothing/small)
	return ..()
...
/obj/item/clothing/glasses/circuitry
	...
	icon = 'sandcode/icons/obj/clothing/circuitry/glasses.dmi'
	mob_overlay_icon = 'sandcode/icons/mob/clothing/circuitry/eyes.dmi'
	anthro_mob_worn_overlay = 'sandcode/icons/mob/clothing/circuitry/eyes.dmi'
	icon_state = "circuitry"
	item_state = "circuitry" // The on-mob sprite would be identical anyways.
...
/obj/item/clothing/shoes/circuitry
	...
	cover."
	icon = 'sandcode/icons/obj/clothing/circuitry/shoes.dmi'
	mob_overlay_icon = 'sandcode/icons/mob/clothing/circuitry/shoes.dmi'
	anthro_mob_worn_overlay = 'sandcode/icons/mob/clothing/circuitry/shoes.dmi'
	icon_state = "circuitry"
	item_state = "circuitry"
...
/obj/item/clothing/mask/circuitry
	...
	icon = 'sandcode/icons/obj/clothing/circuitry/mask.dmi'
	mob_overlay_icon = 'sandcode/icons/mob/clothing/circuitry/mask.dmi'
	anthro_mob_worn_overlay = 'sandcode/icons/mob/clothing/circuitry/mask.dmi'
	icon_state = "circuitry"
	item_state = "circuitry"

/obj/item/clothing/mask/circuitry/Initialize()
	setup_integrated_circuit(/obj/item/electronic_assembly/clothing/small)
	return ..()
...
/obj/item/clothing/ears/circuitry
	...
	icon = 'sandcode/icons/obj/clothing/circuitry/ears.dmi'
	mob_overlay_icon = 'sandcode/icons/mob/clothing/circuitry/ears.dmi'
	anthro_mob_worn_overlay = 'sandcode/icons/mob/clothing/circuitry/ears.dmi'
	icon_state = "circuitry"
	item_state = "circuitry"
...
/obj/item/clothing/suit/circuitry
	...
	icon = 'sandcode/icons/obj/clothing/circuitry/suits.dmi'
	mob_overlay_icon = 'sandcode/icons/mob/clothing/circuitry/suits.dmi'
	anthro_mob_worn_overlay = 'sandcode/icons/mob/clothing/circuitry/suits.dmi'
	icon_state = "circuitry"
	item_state = "circuitry"
