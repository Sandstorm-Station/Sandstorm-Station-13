...
/mob/living/simple_animal/hostile/megafauna/bubblegum
	...
	songs = list("1860" = sound(file = 'sandcode/sound/ambience/bfgdivision.ogg', repeat = 0, wait = 0, volume = 100, channel = CHANNEL_AMBIENCE), "2070" = sound(file = 'sandcode/sound/ambience/theonlythingtheyfearisyou.ogg', repeat = 0, wait = 0, volume = 100, channel = CHANNEL_AMBIENCE)) //Thanks Mr. Infringio!
