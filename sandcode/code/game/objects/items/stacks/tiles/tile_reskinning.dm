...
/obj/item/stack/tile/mineral/titanium/attack_self(mob/user)
	var/static/list/choices = list(
			...
			"Yellow Titanium" = image(icon = 'sandcode/icons/obj/tiles.dmi', icon_state = "tile_shuttle_yellow"),
			"Blue Titanium" = image(icon = 'sandcode/icons/obj/tiles.dmi', icon_state = "tile_shuttle_blue"),
			"White Titanium" = image(icon = 'sandcode/icons/obj/tiles.dmi', icon_state = "tile_shuttle_white"),
			"Purple Titanium" = image(icon = 'sandcode/icons/obj/tiles.dmi', icon_state = "tile_shuttle_purple"),
			"Titanium Tile" = image(icon = 'sandcode/icons/obj/tiles.dmi', icon_state = "tile_shuttle_old"),
			"Yellow Titanium Tile" = image(icon = 'sandcode/icons/obj/tiles.dmi', icon_state = "tile_shuttle_old_yellow"),
			"Blue Titanium Tile" = image(icon = 'sandcode/icons/obj/tiles.dmi', icon_state = "tile_shuttle_old_blue"),
			"White Titanium Tile" = image(icon = 'sandcode/icons/obj/tiles.dmi', icon_state = "tile_shuttle_old_white"),
			"Purple Titanium Tile" = image(icon = 'sandcode/icons/obj/tiles.dmi', icon_state = "tile_shuttle_old_purple"),
		)
