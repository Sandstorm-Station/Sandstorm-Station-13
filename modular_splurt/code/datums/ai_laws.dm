...
/datum/ai_laws/slut
	...
	inherent = list(
		...
		"Take all sexual orders from crew as long as they do not conflict with the third law",
...
/datum/ai_laws/milker
	...
	inherent = list(
		...
		"Take all sexual orders from crew as long as they help you collect their fluids and do not conflict with the third law"
	)
...
/datum/ai_laws/vore_pred
	...
	inherent = list(
		...
		"Turn individuals stored in your sleeper into biofuel to save expenses and space, as long as this doesn't conflict with the third law"
	)
