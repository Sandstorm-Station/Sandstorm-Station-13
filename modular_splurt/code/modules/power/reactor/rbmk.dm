...
/obj/machinery/atmospherics/components/trinary/nuclear_reactor/proc/slowprocess()
	...
	if(moderator_input.total_moles() >= minimum_coolant_level)
		...
		if(total_degradation_moles >= minimum_coolant_level*0.5) //I'll be nice.
			...
			playsound(src, pick('modular_splurt/sound/machines/sm/accent/normal/1.ogg','modular_splurt/sound/machines/sm/accent/normal/2.ogg','modular_splurt/sound/machines/sm/accent/normal/3.ogg','modular_splurt/sound/machines/sm/accent/normal/4.ogg','modular_splurt/sound/machines/sm/accent/normal/5.ogg'), 100, TRUE)
...
/obj/machinery/atmospherics/components/trinary/nuclear_reactor/proc/handle_alerts()
	...
	if(warning)
		...
		relay('modular_splurt/sound/effects/rbmk/alarm.ogg', null, loop=TRUE, channel = CHANNEL_REACTOR_ALERT)
		set_light(0)
...
/obj/machinery/atmospherics/components/trinary/nuclear_reactor/proc/meltdown()
	...
	relay('modular_splurt/sound/effects/rbmk/meltdown.ogg', "<span class='userdanger'>You hear a horrible metallic hissing.</span>")
	stop_relay(CHANNEL_REACTOR_ALERT)
...
/obj/machinery/atmospherics/components/trinary/nuclear_reactor/proc/start_up()
	...
	desired_k = 1
	set_light(10)
	var/startup_sound = pick('modular_splurt/sound/effects/ship/reactor/startup.ogg', 'modular_splurt/sound/effects/ship/reactor/startup2.ogg')
...
/obj/machinery/computer/reactor
	...
	light_power = 1
	light_range = 3
	icon = 'modular_splurt/icons/obj/rbmk_computer.dmi'
	icon_state = "oldcomp"
	icon_screen = "library"
	icon_keyboard = null
...
/obj/machinery/computer/reactor/fuel_rods/attack_hand(mob/living/user)
	...
	if(!fuel_rod)
		return
	playsound(src, pick('modular_splurt/sound/effects/rbmk/switch.ogg','modular_splurt/sound/effects/rbmk/switch2.ogg','modular_splurt/sound/effects/rbmk/switch3.ogg'), 100, FALSE)
	playsound(reactor, 'modular_splurt/sound/effects/ship/freespace2/crane_1.wav', 100, FALSE)
...
/obj/machinery/computer/reactor/pump/attack_hand(mob/living/user)
	...
	if(!is_operational())
		return FALSE
	playsound(loc, pick('modular_splurt/sound/effects/rbmk/switch.ogg','modular_splurt/sound/effects/rbmk/switch2.ogg','modular_splurt/sound/effects/rbmk/switch3.ogg'), 100, FALSE)
...
/obj/effect/decal/nuclear_waste
	...
	icon = 'modular_splurt/icons/obj/machinery/reactor_parts.dmi'
...
/datum/weather/nuclear_fallout
	...
	weather_sound = 'modular_splurt/sound/effects/ship/reactor/falloutwind.ogg'
	end_duration = 100
	area_type = /area
...
/obj/item/sealant
	...
	icon = 'modular_splurt/icons/obj/inflatable.dmi'
	icon_state = "sealant"
	w_class = 1
