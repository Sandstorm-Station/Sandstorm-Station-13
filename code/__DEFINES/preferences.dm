...
#define SOUND_BOSS_MUSIC		(1<<18) // Sandstorm - New Lavaland bosses have musics

#define TOGGLES_DEFAULT (SOUND_ADMINHELP|SOUND_MIDI|SOUND_AMBIENCE|SOUND_LOBBY|MEMBER_PUBLIC|INTENT_STYLE|MIDROUND_ANTAG|SOUND_INSTRUMENTS|SOUND_SHIP_AMBIENCE|SOUND_PRAYERS|SOUND_ANNOUNCEMENTS|ASYNCHRONOUS_SAY|SOUND_BOSS_MUSIC) //Skyrat change - added ASYNCHRONOUS_SAY (Sandcode Addition - SOUND_BOSS_MUSIC)
