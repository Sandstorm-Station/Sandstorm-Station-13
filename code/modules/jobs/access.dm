...
/proc/get_all_accesses()
	return list(ACCESS_SECURITY, ACCESS_SEC_DOORS, ACCESS_BRIG, ACCESS_ARMORY, ACCESS_FORENSICS_LOCKERS, ACCESS_COURT, ACCESS_ENTER_GENPOP, ACCESS_LEAVE_GENPOP,
				...
				ACCESS_PRODUCTION_ENGINEERING,ACCESS_PRODUCTION_SERVICE,ACCESS_PRODUCTION_MEDICAL,ACCESS_PRODUCTION_CARGO,ACCESS_PRODUCTION_SCIENCE,ACCESS_PRODUCTION_SECURITY)
...
/proc/get_region_accesses(code)
	switch(code)
		...
		if(2) //security
			return list(ACCESS_SEC_DOORS, ACCESS_WEAPONS, ACCESS_SECURITY, ACCESS_BRIG, ACCESS_ARMORY, ACCESS_FORENSICS_LOCKERS, ACCESS_COURT, ACCESS_HOS, ACCESS_ENTER_GENPOP, ACCESS_LEAVE_GENPOP, ACCESS_PRODUCTION_SECURITY)
		if(3) //medbay
			return list(ACCESS_MEDICAL, ACCESS_GENETICS, ACCESS_CLONING, ACCESS_MORGUE, ACCESS_CHEMISTRY, ACCESS_VIROLOGY, ACCESS_SURGERY, ACCESS_CMO, ACCESS_PRODUCTION_MEDICAL)
		if(4) //research
