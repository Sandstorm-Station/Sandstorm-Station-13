...
/datum/objective_item/steal/hoslaser
	...
	altitems = list(/obj/item/gun/ballistic/revolver/mws, /obj/item/choice_beacon/hosgun, /obj/item/gun/ballistic/automatic/pistol/enforcerred) //We now look for either the alt verson of the hos gun or the beacon picker.
