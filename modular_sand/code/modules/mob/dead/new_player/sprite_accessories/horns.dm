/datum/sprite_accessory/horns/demon
	name = "Demon"
	icon = 'modular_sand/icons/mob/mutant_bodyparts.dmi'
	icon_state = "demon"
...
/datum/sprite_accessory/horns/sloogbobbers
	name = "Sloog Bobbers"
	icon = 'modular_sand/icons/mob/64_mutant_bodyparts.dmi'
...
/datum/sprite_accessory/horns/big/paintedpoints
	name = "Painted Points"
	icon = 'modular_sand/icons/mob/32x48_mutant_bodyparts.dmi'
