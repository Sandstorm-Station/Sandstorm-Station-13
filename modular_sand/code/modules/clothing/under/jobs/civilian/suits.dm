/obj/item/clothing/under/suit/tuxedo
	...
	icon = 'modular_sand/icons/obj/clothing/under/suits.dmi'
	mob_overlay_icon = 'modular_sand/icons/mob/clothing/under/suits.dmi'
	anthro_mob_worn_overlay = 'modular_sand/icons/mob/clothing/under/suits_digi.dmi'
	icon_state = "tuxedo"
	can_adjust = FALSE
